...
fname = 'test_predictions.txt' # the name of file you want to save the model predictions to
save_path = f'/home/hahmed/model_test/' # the path where the model predictions will be saved
dat_file = '/mnt/d/NACC/patient-data/clinic_data_mapped_cols_renamed.csv' # the test data path
#dat_file = '/mnt/d/NACC/converted_data-5000-aforms-b1b2b8-c1c2c2t.csv' # the test data path
#cnf_file = f'/mnt/d/hahmed/nmed2024/dev/data/toml_files/default_conf_modified.toml' # the path configuration file
cnf_file = f'/mnt/d/hahmed/nmed2024/dev/data/toml_files/default_conf_new.toml' # the path configuration file
#ckpt_path = '/mnt/d/hahmed/nmed2024/dev/ssl_mri/pretrained_models/ckpt_swinunetr_stripped_MNI_AUPR.pt' # the path to the model checkpoint
ckpt_path = '/mnt/d/hahmed/nmed2024/dev/ssl_mri/pretrained_models/ckpt_swinunetr_stripped_MNI.pt' # the path to the model checkpoint
