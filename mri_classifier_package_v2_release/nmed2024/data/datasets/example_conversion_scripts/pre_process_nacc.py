...
# ## Preprocess NACC unique dataset

# In[3]:


def features_conversion(df):
    # df = df.replace({-4: np.NaN, '-4':np.NaN})
    # MRI
    df['mri_zip'] = df['NACCMRFI']
...
# ### Get unique patient visits

# In[ ]:


#mri_data_path = 'investigator_mri_nacc60.csv'
#ftlblbd_data_path = 'investigator_ftldlbd_nacc60.csv'
merged_data_path = '/mnt/d/NACC/nacc-test-cases.csv'
...
merged_data_converted.to_csv('converted_data.csv', index=False)
